...
export declare type ControlValue<Props> = Props extends ControlProps<infer R> ? R : never;
export declare type ControlledProps<Props extends ControlProps<any>> = Omit<Props, keyof ControlProps> & {
